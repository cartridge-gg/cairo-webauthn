...
fn main() -> anyhow::Result<()> {
    ...
    // let db = &mut RootDatabase::builder().with_project_config(ProjectConfig { 
    //     base_path: ".".into(), corelib: Some(Directory::Real("~/.cairo/corelib".into())), content: ProjectConfigContent {crate_roots: OrderedHashMap::default() }
    // }).build()?;
