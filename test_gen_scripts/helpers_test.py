...
class HelpersTest(TestFileCreatorInterface):
    ...
    def get_r_s_extract_tests(self): 
        cases = [(0, 0), (0, 100), (2 ** 256 - 1, 2 ** 256 - 1), (2**256 - 2, 2 ** 256 - 1), (1, 32)]
        return [
    ...
    def get_arrays_equal_tests(self):
        ...
        return [
            ...
            Test(f'arrays_equal_{i}', HelpersTest.generate_array_equal_test(a, b, e)) 
            for i, ((a, b), e) in enumerate(cases)
        ] + [
            Test(f'arrays_equal_different_length', 
